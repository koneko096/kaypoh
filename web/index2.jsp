...
<html lang="en">
    ...
    <body>
        ...
        args[1]=request.getParameter("group2");//"bm";
...
//        args[7]="apapun";
       ...
       <div class="container">
						...
						List<String> picU=Kepo.profpic.get(NamaKategori.size());%>
							...
							<article class="ac-small">
                                <%for(int a=0;a<resultU.size();a++) {%> 
									<div class="picture">
                                        <img alt="" src=<%=picU.get(a)%> id="image"/>
                                    </div>
                                    <div class="Twit">
							...
							<input id="ac-<%=i%>" name="accordion-1" type="radio" checked />
                                ...
                                <article class="ac-small">
                                    ...
                                    <% for(int a=0;a<result.size();a++) {
                                        ...
                                        <div class="picture">
                                            <img alt="" src=<%=picture%> id="image"/>
                                        </div>
                                        <div class="Twit">
						<h1><a href= <%="https://twitter.com/"+username%> > @<%=username%> </a> </h1>
                                                <p> <%=result.get(a)%> </p>
        ...
        <a href="home.jsp"><div class="btn">About</div></a>
